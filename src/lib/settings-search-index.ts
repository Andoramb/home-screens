...
export const SETTINGS_FIELD_INDEX: SettingsFieldEntry[] = [
  ...
  { pageId: 'screen', fieldId: 'display.transitionEffect', labelKey: 'settings.defaultDisplayPage.fields.transitionEffectLabel', panel: 'appearance', keywordKeys: ['settings.defaultDisplayPage.fields.transitionEffectHelp'] },
